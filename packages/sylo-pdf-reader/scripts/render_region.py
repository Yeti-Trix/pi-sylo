#!/usr/bin/env python3
"""Render a cropped PDF region to PNG for vision inspection."""
...
from pdf_region import DEFAULT_REGION_DPI, render_region


def main() -> int:
    parser = argparse.ArgumentParser(description="Render a cropped PDF region to PNG.")
    ...
    parser.add_argument("--dpi", type=int, default=DEFAULT_REGION_DPI)
