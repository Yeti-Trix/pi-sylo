...
/**
 * Resolve how to spawn a child `pi` CLI from the Sylo broker (not the Pi TUI entry).
 * Prefers `@earendil-works/pi-coding-agent/dist/cli.js` via NODE_PATH / require.resolve.
 */
